...
#define BTPM_CONFIGURATION_DEVICE_MANAGER_DEFAULT_CONNECTION_SCAN_INTERVAL    100
#define BTPM_CONFIGURATION_DEVICE_MANAGER_DEFAULT_CONNECTION_SCAN_WINDOW      100
...
#define BTPM_CONFIGURATION_CSC_NUM_OF_SENSORS_SUPPORTED						   1
