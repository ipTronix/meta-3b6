...
#define BTPM_DEBUG_LEVEL_FORCE_PRINT            BTPM_DEBUG_LEVEL_WARNING
...
#define DEBUG_FUNC(x)     			DebugPrint(MODULE_DBG_ID|BTPM_DEBUG_LEVEL_FUNCTION, x)
#define DEBUG_VERBOSE(x)  			DebugPrint(MODULE_DBG_ID|BTPM_DEBUG_LEVEL_VERBOSE,  x)
#define DEBUG_WARNING(x)  			DebugPrint(MODULE_DBG_ID|BTPM_DEBUG_LEVEL_WARNING,  x)
#define DEBUG_FAILURE(x)  			DebugPrint(MODULE_DBG_ID|BTPM_DEBUG_LEVEL_FAILURE,  x)
