...
#define SCOM_MESSAGE_FUNCTION_SET_ENHANCED_TRANSPORT_PARAMETERS 0x00001006
...
#define SCOM_CLOSE_CONNECTION_RESPONSE_SIZE                    (sizeof(SCOM_Close_Connection_Response_t))
   ...
   /* The following structure represents the Message definition for a   */
   /* SCO Manager Message to set the enhanced parameters for all SCO    */
   /* connections (Request).                                            */
   /* * NOTE * This is the message format for the                       */
   /*                                                                   */
   /*     SCOM_MESSAGE_FUNCTION_SET_ENHANCED_TRANSPORT_PARAMETERS       */
   /*                                                                   */
   /*          Message Function ID.                                     */
typedef struct _tagSCOM_Set_Enhanced_Transport_Parameters_Request_t
{
   BTPM_Message_Header_t               MessageHeader;
   SCO_Enhanced_Transport_Parameters_t EnhancedTransportParameters;
} SCOM_Set_Enhanced_Transport_Parameters_Request_t;

#define SCOM_SET_ENHANCED_TRANSPORT_PARAMETERS_REQUEST_SIZE    (sizeof(SCOM_Set_Enhanced_Transport_Parameters_Request_t))
   ...
   /*                                                                   */
   /*          Message Function ID.                                     */
typedef struct _tagSCOM_Set_Enhanced_Transport_Parameters_Response_t
{
   BTPM_Message_Header_t MessageHeader;
   int                   Status;
} SCOM_Set_Enhanced_Transport_Parameters_Response_t;

#define SCOM_SET_ENHANCED_TRANSPORT_PARAMETERS_RESPONSE_SIZE   (sizeof(SCOM_Set_Enhanced_Transport_Parameters_Response_t))
