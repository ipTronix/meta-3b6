...
typedef struct _tagSPPM_Configure_MFi_Settings_Request_t
{
   ...
   /* number of FID Token data bytes that are to be written in the      */
   ...
   /*          bytes.                                                   */
#define SPPM_CONFIGURE_MFI_SETTINGS_REQUEST_SIZE(_x)           (STRUCTURE_OFFSET(SPPM_Configure_MFi_Settings_Request_t, VariableData) + (unsigned int)(_x))
