...
BTPSAPI_DECLARATION int BTPSAPI DEVM_DisconnectRemoteDevice(BD_ADDR_t RemoteDevice, unsigned long DisconnectFlags);
   ...
   /* there was an error.                                               */
BTPSAPI_DECLARATION int BTPSAPI DEVM_SetRemoteDeviceLinkSniff(BD_ADDR_t RemoteDevice, unsigned int SniffMaxInterval, unsigned int SniffMinInterval, unsigned int SniffAttempt, unsigned int SniffTimeout);

#ifdef INCLUDE_BLUETOOTH_API_PROTOTYPES
   typedef int (BTPSAPI *PFN_DEVM_SetRemoteDeviceLinkSniff_t)(BD_ADDR_t RemoteDevice, unsigned int SniffMaxInterval, unsigned int SniffMinInterval, unsigned int SniffAttempt, unsigned int SniffTimeout);
#endif
...
BTPSAPI_DECLARATION int BTPSAPI DEVM_SendRawHCICommand(unsigned char OGF, unsigned short OCF, unsigned char CommandLength, unsigned char CommandData[], unsigned char *ResultStatus, unsigned char *ResultLength, unsigned char *ResultBuffer, Boolean_t WaitForResponse);
   ...
   /* negative return error code if there was an error.                 */
BTPSAPI_DECLARATION int BTPSAPI DEVM_QueryConnectionHandle(BD_ADDR_t RemoteDeviceAddress, Word_t *Connection_Handle);
...
#ifdef INCLUDE_BLUETOOTH_API_PROTOTYPES
   typedef int (BTPSAPI *PFN_DDEVM_Set_And_Update_Connection_And_Scan_Parameters_t)(BD_ADDR_t *BD_ADDR, AddressType_t *AddressType, GAP_LE_Connection_Parameters_t *ConnectionParameters, Word_t *ConnectionScanInterval, Word_t *ConnectionScanWindow, Word_t *ScanInterval, Word_t *ScanWindow);
#endif
