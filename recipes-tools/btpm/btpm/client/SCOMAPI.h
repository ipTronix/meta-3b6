...
BTPSAPI_DECLARATION int BTPSAPI SCOM_SetEnhancedTransportParameters(SCO_Enhanced_Transport_Parameters_t *EnhancedTransportParameters);

#ifdef INCLUDE_BLUETOOTH_API_PROTOTYPES
   typedef int (BTPSAPI *PFN_SCOM_SetEnhancedTransportParameters_t)(SCO_Enhanced_Transport_Parameters_t *EnhancedTransportParameters);
#endif
